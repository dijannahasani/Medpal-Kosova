  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      try {
        ...
        const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/appointments/all`, {
              ...
              <div className="card-body p-5">
                ...
                <div className="mb-4" style={{
                  ...
                  <div className="clinic-calendar-wrapper">
                    {/* Custom header: show full month + year and allow tapping to change view */}
                    ...
                    <Calendar
                      ...
                      onChange={(d) => {
                        setDate(d);
                        // When a date is selected from year view, switch back to month view
